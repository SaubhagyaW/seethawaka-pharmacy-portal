        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          <div className="max-w-xl animate-fade-up" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="flex flex-wrap gap-4">
              <Link 
                to="/about" 
                className="inline-flex items-center justify-center px-6 py-3 rounded-full bg-pharmacy-600 text-white font-medium transition-all hover:bg-pharmacy-700 active:scale-[0.98] shadow-sm"
              >
                About Us
          ...
          <div className="relative lg:h-[500px] animate-fade-up" style={{ animationDelay: '0.3s' }}>
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-pharmacy-100 to-pharmacy-50 transform rotate-3 scale-[0.96] animate-fade-in" style={{ animationDelay: '0.6s' }}></div>
            <div className="relative overflow-hidden rounded-2xl shadow-xl h-full">
              <img 
                ...
                loading="lazy"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-pharmacy-950/30 to-transparent"></div>
            </div>
          </div>
        </div>
      </div>
