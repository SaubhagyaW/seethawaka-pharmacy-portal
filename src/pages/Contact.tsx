...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (isProduction) {
      // For production - let Netlify handle the form normally
      ...
      // Prevent default and handle with fetch to have better control
      e.preventDefault();
      ...
      try {
        ...
        toast.error("Failed to send message", {
          description: "Please try again or contact us directly at +94 72 383 6007",
        });
      } finally {
