                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
                        ...
                        <div className="bg-white rounded-xl p-8 border border-gray-100 shadow-sm animate-fade-up">
                            ...
                            <p className="text-gray-600 mb-8">
                                Visit our brand new pharmacy for personalized care or contact us using any of the
                                methods below.
                            </p>
                        ...
                        <div className="bg-white rounded-xl p-8 border border-gray-100 shadow-sm animate-fade-up"
                            ...
                            {/* Pure HTML form - no React interference */}
                                ...
                                <form name="contact" method="POST" data-netlify="true" data-netlify-honeypot="bot-field">
                                  ...
                                  <div style="margin-bottom: 1.5rem;">
                                    ...
                                    <input 
                                      ...
                                      required 
                                      style="display: flex; height: 2.5rem; width: 100%; border-radius: 0.375rem; border: 1px solid #d1d5db; background-color: #ffffff; padding: 0.5rem 0.75rem; font-size: 0.875rem;"
                                    />
                                  </div>
                                  ...
                                  <div style="margin-bottom: 1.5rem;">
                                    <label for="message" style="display: block; font-size: 0.875rem; font-weight: 500; color: #374151; margin-bottom: 0.5rem;">
                                      Message *
                                    </label>
                                    <textarea 
                                      name="message" 
                                      ...
                                      required 
                                      rows="5"
                                      style="display: flex; min-height: 5rem; width: 100%; border-radius: 0.375rem; border: 1px solid #d1d5db; background-color: #ffffff; padding: 0.5rem 0.75rem; font-size: 0.875rem; resize: none;"
                                    ></textarea>
                                  </div>
                          
                                  <button 
                                    type="submit" 
                                    style="display: inline-flex; align-items: center; justify-content: center; width: 100%; height: 2.5rem; border-radius: 0.375rem; background: linear-gradient(to right, #00A99D, #F5A623); color: white; font-weight: 500; border: none; cursor: pointer;"
                                  >
                                    Send Message
                                  </button>
                                </form>
